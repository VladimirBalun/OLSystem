new Vue({
    ...
    data: {
        ...
        descriptionOlympiad : "Подробное описание проводимой олимпиады. Также данные, касаемо каких-то тонскостей проведения олимпиады, информация об участниках и многое другое о проводимой олимпиаде.",
