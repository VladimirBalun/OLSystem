...
<%@ page import="ru.tidstu.testingsystem.services.models.User" %>
<%@ page import="java.util.List" %>
<%@ page import="ru.tidstu.testingsystem.services.models.Question" %>
<%@ page import="ru.tidstu.testingsystem.services.models.Result" %>
...
<%
    ...
    List<User> users = userMaker.getUsers();
    pageContext.setAttribute("users", users);
    List<Question> questions = questionsService.getAllQuestions();
    pageContext.setAttribute("questions", questions);
    List<Result> resultsOfUsers = resultsService.getResultsOfUsers(SortingResults.DATE);
    pageContext.setAttribute("resultsOfUsers", resultsOfUsers);
%>
...
<jsp:include page="templates/header.jsp"/>
    ...
    <div class="container-fluid wrapper">
        ...
        <header class="row header_admin">
            ...
            <div class="col-lg-4 col-md-4">
                <p class="data_admin"><%=basicDataService.getCurrentDate()%></p>
            </div>
            ...
            <section class="basic_data" hidden>
                ...
                <form action="/BasicData" name="basic_titels" method="POST" class="wrapper_admin row">
                    <div class="col-lg-5 col-md-5">
                        ...
                        <input name="title_test" type="text" class="input_admin" value="<%=basicDataService.getTitleOfTest()%>">
                    </div>
                    <div class="col-lg-5 col-md-5">
                        <label class="label_admin">Заголовок результата тестирования:</label>
                        <input name="title_result_test" type="text" class="input_admin" value="<%=basicDataService.getTitleOfResult()%>">
                    </div>
                ...
                <form action="/BasicData" name="basic_contacts" method="POST" class="wrapper_admin row">
                    <div class="col-lg-4 col-md-4">
                        ...
                        <input name="name_college" type="text" class="input_admin" value="<%=basicDataService.getNameOfCollege()%>">
                    </div>
                    <div class="col-lg-3 col-md-3">
                        <label class="label_admin">Адрес:</label>
                        <input name="address" type="text" class="input_admin" value="<%=basicDataService.getAddress()%>">
                    </div>
                    <div class="col-lg-3 col-md-3">
                        <label class="label_admin">Телефон:</label>
                        <input name="phone_number" type="text" class="input_admin" value="<%=basicDataService.getPhoneNumber()%>">
                    </div>
                    <div class="col-lg-2 col-md-2">
                        <button class="button_admin">Изменить</button>
                    </div>
                ...
                <form action="/BasicData" name="basic_descriptions" method="POST" class="wrapper_admin row">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <textarea name="description_test" class="textarea_admin"><%=basicDataService.getDescriptionOfTest()%></textarea>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <label class="label_admin">Описание результата тестирования:</label>
                        <textarea name="description_result_test" class="textarea_admin"><%=basicDataService.getDescriptionOfResult()%></textarea>
                    </div>
                    <div class="col-lg-2 col-md-2">
                        <button class="button_admin">Изменить</button>
                    </div>
    ...
    <script src="js/admin_room/questions.js"></script>
    <script src="js/admin_room/users.js"></script>
    <script src="js/admin_room/groups.js"></script>
    <script src="js/admin_room/results.js"></script>
