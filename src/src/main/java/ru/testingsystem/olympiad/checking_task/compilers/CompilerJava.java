...
public class CompilerJava extends Compiler {
    ...
    public boolean compileProgram(String sourceProgram) {
        createSourceFile(pathSourceProgram + "/test.java", sourceProgram);
        String command = "cd " + pathSourceProgram + " && javac test.java";
    ...
    public boolean runProgram(List<TestData> testDataForProgram) {
        ...
        try {
            ...
            removeSourceAndExecutableFile("/test.java", "/test.jar");
        } catch (IOException e){
    ...
    private boolean testProgramUsingTestData(List<TestData> testDataForProgram) throws IOException{
        for (TestData testData : testDataForProgram){
            ...
            BufferedReader bufferedReader = terminal.runCommand("cd " + pathSourceProgram + " java test " + testData.getInputData());
