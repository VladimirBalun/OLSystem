...
public class CompilerCTest {
    ...
    public void testErrorCompilation(){
        ...
        String source = "#include <stdio.h> \n" +
                ...
                "    return 0; \n" +
                "}";
        ResultCheckingProgram result = compilerC.checkProgram("Test", source, null);
    ...
    public void testErrorRunningProgram(){
        ...
        ResultCheckingProgram result = compilerC.checkProgram("Test", source, testDataForProgram);
